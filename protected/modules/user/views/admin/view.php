    ...
    <div class="card card-user">
        ...
        <div class="content">
            <div class="author">
              ...
              <h4 class="title"><?php echo CHtml::encode($model->profile->name); ?> (<?php echo $model->id; ?>)<br />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-input" disabled placeholder="Company" value="<?php print ($model->superuser == 1)? "Sim" : "Não"; ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
